...
export const brands: Brand[] = [
    ...
    products: [
      {
        ...
        related: ["brivis-buffalo-internal", "brivis-evap", "kaden-gas-ducted-3-internal"],
      },
      {
        ...
        photoAlt: "Brivis Buffalo higher-spec internal gas ducted heater",
        ...
        related: ["brivis-buffalo-external", "brivis-wombat-internal", "brivis-starpro-45"],
      },
      {
        slug: "brivis-buffalo-external",
        name: "Brivis Buffalo External Gas Ducted",
        model: "Buffalo (external cabinet)",
        category: "ducted",
        categoryLabel: "External gas ducted heater (higher-spec)",
        capacity: "Higher-spec external cabinet heater · matched to your heat load",
        veuEligible: false,
        photo: "/Brivis Buffalo Outdorr.jpg",
        photoAlt: "Brivis Buffalo external gas ducted heater cabinet",
        bestFor: "External-cabinet retrofit where the customer wants the higher-spec Buffalo package but the heater lives outdoors",
        ourTake:
          "The Buffalo external is the outdoor-cabinet version of the higher-spec Buffalo · same quieter inverter fan and longer service life as the internal Buffalo, packaged in a weatherproof cabinet for homes that were built with the ducted heater outside on a pad.",
        specs: [
        ...
        related: ["brivis-buffalo-internal", "brivis-starpro-6"],
      },
      {
        slug: "brivis-starpro-45",
        name: "Brivis Starpro 4 & 5-Star Ducted (Internal + External)",
        model: "Starpro 4★ / 5★ · internal + external variants",
        category: "ducted",
        categoryLabel: "Mid-tier efficiency gas ducted heater",
        capacity: "4-star and 5-star options · both internal cupboard + external cabinet variants",
        starRating: "4-star / 5-star",
        veuEligible: false,
        photo: "/Brivis Starpro 4 and 4 & 5 star indoor verison and external verson .jpg",
        photoAlt: "Brivis Starpro 4/5-star gas ducted — internal + external variants",
        bestFor: "Customers wanting mid-tier efficiency (4-5 star) without going to the premium 6-star Starpro",
        ourTake:
          "Starpro 4/5-star is Brivis's mid-tier efficiency ducted heater · a meaningful running-cost step-up from the Wombat 3-star without paying premium 6-star money. Available in both internal cupboard and external cabinet variants so it fits whatever cavity the home was built with.",
        specs: [
          { label: "Star rating options", value: "4-star or 5-star" },
          { label: "Install position", value: "Internal cupboard OR external weatherproof cabinet" },
          { label: "Gas type", value: "Natural gas or LPG" },
          { label: "Controller compatibility", value: "Brivis Networker + Touch wall controller" },
          { label: "Heat exchanger warranty", value: "7-year (aluminised steel)" },
          { label: "Unit warranty", value: "3-year full unit + 6-year workmanship" },
        ],
        related: ["brivis-starpro-6", "brivis-buffalo-internal", "brivis-wombat-internal"],
      },
      {
        slug: "brivis-starpro-6",
        name: "Brivis Starpro 6-Star Ducted (Internal + External)",
        model: "Starpro 6★ · internal + external variants",
        category: "ducted",
        categoryLabel: "Premium 6-star gas ducted heater",
        capacity: "6-star premium efficiency · both internal cupboard + external cabinet variants",
        starRating: "6-star",
        veuEligible: false,
        photo: "/Brivis Starpro 6 star indoor and outdoor gas ducted heater.jpg",
        photoAlt: "Brivis Starpro 6-star gas ducted — internal + external variants",
        bestFor: "Customers wanting Brivis's most efficient gas ducted heater to genuinely cut winter gas bills",
        ourTake:
          "Starpro 6-star is Brivis's most efficient gas ducted heater · we quote it when the customer's staying on gas long-term and wants to genuinely knock down winter running cost. Modulating burner, higher heat-exchanger efficiency, and available in both internal cupboard and external cabinet variants.",
        specs: [
        ...
        related: ["brivis-starpro-45", "brivis-buffalo-internal"],
      },
      {
        slug: "brivis-evap",
  ...
  // ================== KADEN ==================
  {
    ...
    products: [
      ...
      {
        slug: "kaden-gas-ducted-3-internal",
        name: "Kaden Gas Ducted · 3-Star Internal",
        model: "KGH-3 (Compact Universal)",
        category: "ducted",
        categoryLabel: "Gas ducted heating · 3-star internal",
        capacity: "15 · 20 · 25 · 30 kW output · internal cupboard mount",
        starRating: "3-star",
        veuEligible: false,
        photo: "/kaden_internal_ducted_heater_3 star.jpg",
        photoAlt: "Kaden 3-star internal gas ducted heater",
        bestFor: "Like-for-like value replacement of an aging Brivis 3-star internal cupboard heater",
        ourTake:
          "The 3-star internal is Kaden's entry-tier ducted heater · designed to drop straight into an existing Brivis or Braemar cupboard cavity so the retrofit is quick, ducts reuse and cost stays down. What we quote when the customer wants to stay on gas and doesn't need to chase efficiency past 3-star.",
        specs: [
        ...
        related: ["kaden-gas-ducted-3-external", "kaden-gas-ducted-45-internal", "brivis-wombat-internal"],
      },
      {
        slug: "kaden-gas-ducted-3-external",
        name: "Kaden Gas Ducted · 3-Star External",
        model: "KGH-3-EXT (Compact Universal · external cabinet)",
        category: "ducted",
        categoryLabel: "Gas ducted heating · 3-star external",
        ...
        bestFor: "Retrofit into homes where the ducted heater lives outside on a pad, not in an internal cupboard",
        ourTake:
          "The 3-star external is the sibling of the internal 3-star — same core burner and heat exchanger, packaged in a weatherproof outdoor cabinet for homes that were built with the heater outdoors. Common on older Endeavour Hills / Berwick weatherboards where the ducted heater sits on an external slab.",
        specs: [
          { label: "Star rating", value: "3-star" },
          { label: "Output range", value: "15 · 20 · 25 · 30 kW" },
          { label: "Install position", value: "External weatherproof cabinet on pad" },
        ...
        related: ["kaden-gas-ducted-3-internal", "kaden-gas-ducted-45-external"],
      },
      {
        slug: "kaden-gas-ducted-45-internal",
        name: "Kaden Gas Ducted · 4 & 5-Star Starpro Internal",
        model: "Starpro 4★ / 5★ Internal",
        category: "ducted",
        categoryLabel: "Gas ducted heating · 4/5-star internal",
        capacity: "15 · 20 · 25 · 30 kW output · internal cupboard mount",
        starRating: "4-star / 5-star",
        veuEligible: false,
        photo: "/kaden_internal_ducted_heater_star pro 4 and 5  star.jpg",
        photoAlt: "Kaden Starpro 4/5-star internal gas ducted heater",
        bestFor: "In-cupboard retrofit where the customer wants a step up in efficiency without going to a 6-star premium",
        ourTake:
          "Starpro is Kaden's mid-tier ducted heater in 4-star or 5-star efficiency · what we quote when the customer wants a meaningful running-cost drop vs the 3-star without paying premium 6-star money. Same internal cupboard footprint as the 3-star so retrofit stays clean.",
        specs: [
          { label: "Star rating options", value: "4-star or 5-star" },
          { label: "Output range", value: "15 · 20 · 25 · 30 kW" },
          { label: "Install position", value: "Internal cupboard" },
      ...
      {
        slug: "kaden-gas-ducted-45-external",
        name: "Kaden Gas Ducted · 4 & 5-Star Starpro External",
        model: "Starpro 4★ / 5★ External",
        category: "ducted",
        categoryLabel: "Gas ducted heating · 4/5-star external",
        capacity: "15 · 20 · 25 · 30 kW output · external cabinet",
        starRating: "4-star / 5-star",
        veuEligible: false,
        photo: "/kaden_external_ducted_heater_4 and 5 star.jpg",
        photoAlt: "Kaden Starpro 4/5-star external gas ducted heater cabinet",
        bestFor: "External-cabinet retrofit where the customer wants better efficiency than the 3-star external",
        ourTake:
          "Starpro external is the outdoor-cabinet version of the mid-tier 4/5-star ducted heater · same efficiency step-up as the internal Starpro, packaged for the homes that were built with the ducted heater outdoors. Weatherproof cabinet, direct-spark ignition, universal footprint.",
        specs: [
          { label: "Star rating options", value: "4-star or 5-star" },
          { label: "Output range", value: "15 · 20 · 25 · 30 kW" },
          { label: "Install position", value: "External weatherproof cabinet on pad" },
        ...
        related: ["kaden-gas-ducted-3-external", "kaden-gas-ducted-45-internal"],
      },
      {
        ...
        related: ["kaden-ducted-14", "kaden-gas-ducted-3-internal"],
      },
    ],
  },
