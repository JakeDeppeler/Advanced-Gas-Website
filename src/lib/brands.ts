    ...
    products: [
      {
        ...
        related: ["brivis-internal-buffalo", "brivis-internal-starpro-45", "brivis-external-buffalo"],
      },
      {
        slug: "brivis-internal-buffalo",
        name: "Brivis Buffalo · Internal",
        ...
        ourTake:
          "The Buffalo is Brivis's higher-spec internal ducted heater · quieter operation, better fan and longer service life than the Wombat sibling. What we quote when the customer wants the heater they'll keep for 15+ years without babying it.",
        specs: [
          { label: "Output range", value: "15 · 20 · 25 · 30 kW" },
      ...
      },
      {
        ...
        related: ["brivis-external-starpro-45", "brivis-internal-buffalo"],
      },
      {
  ...
  // ================== RECLAIM ENERGY ==================
  {
    ...
    products: [
      ...
      // ---- Panasonic CO₂ Split (Reclaim tank + Panasonic Aquarea heat pump) ----
      {
        ...
        name: "Panasonic CO₂ Split · 4 kW · 250L",
        model: "Panasonic Aquarea 4 kW + Reclaim 250 L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump",
        capacity: "250 L tank · 4 kW Panasonic Aquarea compressor",
        refrigerant: "R744 (CO₂)",
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Panasonic CO₂ split heat pump · 4 kW compressor + 250L Reclaim tank",
        bestFor: "Couples / family of 3 wanting the Panasonic Aquarea compressor on the Reclaim tank platform",
        ourTake:
          "Reclaim's Panasonic partnership pairs the Aquarea 4 kW CO₂ compressor with a Reclaim-branded tank on the same platform as the standard Reclaim CO₂ splits. The 250 L is the compact option for couples and small households. Tank finish (glass-lined / stainless / 316 duplex) is a spec choice with the same warranty ladder as the pure-Reclaim range.",
        specs: [
      ...
      },
      {
        ...
        name: "Panasonic CO₂ Split · 4 kW · 315L",
        model: "Panasonic Aquarea 4 kW + Reclaim 315 L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump",
        ...
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Panasonic CO₂ split heat pump · 4 kW compressor + 315L Reclaim tank",
        bestFor: "Family of 4-5 wanting the Panasonic Aquarea compressor on the Reclaim tank platform",
        ourTake:
          "The 315 L is the family-sized pairing in the Panasonic range · same 4 kW Aquarea compressor as the 250 L, matched to a larger tank for higher household draw. Tank warranties are identical to the standard Reclaim CO₂ range, so buyers get the same long-life stainless option.",
        specs: [
          { label: "Compressor", value: "Panasonic Aquarea 4 kW · CO₂ (R744)" },
          { label: "Tank capacity", value: "315 L" },
          { label: "Tank finish options", value: "Glass-lined · Stainless · 316 duplex (Earthworker)" },
      ...
      },
      {
        ...
        name: "Panasonic CO₂ Split · 6 kW · 250L",
        model: "Panasonic Aquarea 6 kW + Reclaim 250 L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump",
        ...
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Panasonic CO₂ split heat pump · 6 kW compressor + 250L Reclaim tank",
        bestFor: "Cold-climate households wanting faster recovery on the compact tank",
        ourTake:
          "The 6 kW Aquarea compressor gives faster tank recovery than the 4 kW · matters most in the hills (Emerald, Gembrook, Cockatoo) where cold-morning demand spikes are the tough case. The 6 kW also modulates further down, so at typical part-load it runs MORE efficiently than the 4 kW despite the larger nameplate.",
        specs: [
        ...
        related: ["panasonic-co2-6kw-315", "panasonic-co2-4kw-250", "co2-split-250-stainless"],
      },
      {
        slug: "panasonic-co2-6kw-315",
        name: "Panasonic CO₂ Split · 6 kW · 315L",
        model: "Panasonic Aquarea 6 kW + Reclaim 315 L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump",
        ...
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Panasonic CO₂ split heat pump · 6 kW compressor + 315L Reclaim tank",
        bestFor: "Larger families in cold-climate suburbs — biggest capacity in the Panasonic Aquarea range",
        ourTake:
          "The top of the Panasonic range · 6 kW Aquarea compressor with the family-size 315 L tank. Best pick for a larger family in a hills postcode where cold-morning recovery matters and household draw is high. Above this we'd move to the 400 L pure-Reclaim CO₂ — the Aquarea platform caps at 315 L.",
        specs: [
          { label: "Compressor", value: "Panasonic Aquarea 6 kW · CO₂ (R744)" },
          { label: "Tank capacity", value: "315 L" },
          { label: "Tank finish options", value: "Glass-lined · Stainless · 316 duplex (Earthworker)" },
