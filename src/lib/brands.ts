...
export const brands: Brand[] = [
    ...
    products: [
      {
        ...
        related: ["brivis-gas-external", "brivis-evap"],
      },
      {
        ...
        related: ["brivis-gas-internal", "brivis-evap"],
      },
      {
        slug: "brivis-evap",
        name: "Brivis Evaporative Cooler",
        model: "Contour (Classic) + Advance (Low-Profile)",
        category: "ducted",
        categoryLabel: "Roof-mounted evaporative cooling · two silhouettes",
        capacity: "15 · 20 · 26 · 30 kW · Classic + Low-Profile roof silhouettes",
        veuEligible: false,
        photo: "/evap-cooler-service.webp",
        photoAlt: "Brivis roof-mounted evaporative cooler — Contour + Advance silhouettes",
        bestFor: "Dry-summer suburbs wanting whole-home cooling at ~25% of refrigerated running cost",
        ourTake:
          "Brivis evap comes in two silhouettes so we can match it to the roofline · Contour is the taller Classic profile, Advance is the flatter Low-Profile for street-view sensitive homes or lower pitches. Both push cooled air through ceiling vents · works brilliantly in Melbourne's dry heatwaves (Cranbourne, Clyde, Officer) and cools a whole home for a fraction of refrigerated ducted running cost. Less effective on humid days, but for most of a Melbourne summer it's the right pick when running-cost matters.",
        specs: [
          { label: "Silhouette options", value: "Contour (Classic profile) · Advance (Low-Profile)" },
          { label: "Output range", value: "15 · 20 · 26 · 30 kW" },
          { label: "Install position", value: "Roof-mounted (matched to roof pitch + street aspect)" },
        ...
        features: [
          "Two silhouettes (Classic Contour + Low-Profile Advance) — match to roofline and street aspect",
          "Four output sizes (15 / 20 / 26 / 30 kW) — matched to the home's cooling load",
          "Roof-mounted install pushes cooled air through ceiling vents — whole-home cooling with one unit",
        ...
        whyWeInstall: [
          "The right cooling call for the dry-summer suburbs (Cranbourne, Clyde, Officer) where refrigerated overspecs the load",
          "Low-Profile Advance keeps street-view rooflines clean — matters for character-street cases",
          "Rinnai-backed parts pipeline — Brivis evap parts are same-day from Melbourne",
          "Backed by our 6-year workmanship warranty on top of Brivis's 5-year manufacturer cover",
        ],
        related: ["brivis-gas-internal", "brivis-gas-external", "kaden-evaporative"],
      },
    ],
  },
  ...
  // ================== MITSUBISHI ELECTRIC ==================
  {
    ...
    products: [
      ...
      },
      {
        ...
        ourTake:
          "The 5F is the 5-head multi-head. One outdoor, five indoor. When you're pushing past this we move to the MXZ-6C (12 kW / 6-port) or ducted.",
        specs: [
      ...
      {
        slug: "mxz-6c",
        name: "MXZ-6C Multi-Head Outdoor · 12 kW · 6-Port",
        model: "MXZ-6C120VA (6-port multi-split condenser)",
        category: "multi-head",
        categoryLabel: "Multi-head outdoor unit · 6-port",
        ...
        ourTake:
          "The MXZ-6C is Mitsubishi's 12 kW / 6-port multi-head — the biggest condenser in the range, 6 indoor heads off one outdoor unit. What we quote for a 5-6 bed home that wants proper per-room control without going ducted. Only one outdoor to place, only one refrigerant loop to service.",
        specs: [
          { label: "Combined cool", value: "12.0 kW" },
          { label: "Combined heat", value: "14.0 kW" },
          { label: "Heads supported", value: "6 (indoor unit mix from MSZ-AP, MFZ-KW, cassette)" },
        ...
        features: [
          ...
          "6 indoor heads supported — mix and match wall splits, floor consoles and cassettes off one refrigerant loop",
          "R32 refrigerant + inverter compressor — modern efficiency in a large-capacity multi-head",
          "1-phase power supply — no 3-phase upgrade required at the meter box",
          "One condenser to service instead of six — parts pipeline stays simple",
        ],
        whyWeInstall: [
          "The pick when the family wants per-room control on 5-6 rooms without going ducted",
          "One outdoor unit instead of six splits — cleaner externally, quieter for neighbours",
          "Same MSZ-AP indoor units as the single-splits, so the interior finish is consistent",
  ...
  // ================== RECLAIM ENERGY ==================
  {
    ...
    products: [
      ...
      {
        slug: "panasonic-co2-4kw-250",
        name: "Reclaim × Panasonic CO₂ Split · 4 kW · 250L",
        model: "Panasonic Aquarea 4 kW compressor + Reclaim 250L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump · 250L",
        capacity: "250 L tank · 4 kW Panasonic Aquarea compressor",
        refrigerant: "R744 (CO₂)",
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Reclaim × Panasonic CO₂ split heat pump · 4 kW compressor + 250L tank",
        bestFor: "Couples / family of 3 wanting the Panasonic Aquarea compressor on the Reclaim tank platform",
        ourTake:
          "Reclaim's Panasonic partnership pairs the Panasonic Aquarea 4 kW CO₂ compressor with a Reclaim-branded tank on the same platform as the standard Reclaim CO₂ splits. Same 15-year stainless / 10-year glass tank warranty options carry over; the compressor swaps to the Panasonic unit for buyers who specifically want the Aquarea badge. 4 kW is the compact option for couples / small households.",
        specs: [
          { label: "Compressor", value: "Panasonic Aquarea 4 kW · CO₂ (R744)" },
          { label: "Tank capacity", value: "250 L (glass-lined or stainless — 316 duplex optional)" },
        ...
        related: ["panasonic-co2-4kw-315", "panasonic-co2-6kw-250", "co2-split-250-stainless"],
      },
      {
        slug: "panasonic-co2-4kw-315",
        name: "Reclaim × Panasonic CO₂ Split · 4 kW · 315L",
        model: "Panasonic Aquarea 4 kW compressor + Reclaim 315L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump · 315L",
        capacity: "315 L tank · 4 kW Panasonic Aquarea compressor",
        refrigerant: "R744 (CO₂)",
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Reclaim × Panasonic CO₂ split heat pump · 4 kW compressor + 315L tank",
        bestFor: "Family of 4-5 wanting the Panasonic Aquarea compressor on the Reclaim tank platform",
        ourTake:
          "The 315 L Panasonic pairing is the family-sized option in the Reclaim × Panasonic range · same 4 kW Aquarea compressor as the 250 L, matched to a larger tank for higher-draw households. Tank warranties are identical to the standard Reclaim CO₂ range so buyers get the same long-life stainless option they'd get on a pure Reclaim compressor.",
        specs: [
          { label: "Compressor", value: "Panasonic Aquarea 4 kW · CO₂ (R744)" },
          { label: "Tank capacity", value: "315 L (glass-lined or stainless — 316 duplex optional)" },
          { label: "Tank warranty", value: "10-yr glass-lined · 15-yr stainless · 15-yr 316 duplex" },
          { label: "Compressor warranty", value: "5-year Panasonic + 6-year workmanship" },
          { label: "Note", value: "No 400 L option on the Panasonic Aquarea platform — max tank is 315 L" },
        ],
        related: ["panasonic-co2-4kw-250", "panasonic-co2-6kw-315", "co2-split-315-stainless"],
      },
      {
        slug: "panasonic-co2-6kw-250",
        name: "Reclaim × Panasonic CO₂ Split · 6 kW · 250L",
        model: "Panasonic Aquarea 6 kW compressor + Reclaim 250L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump · 250L · 6 kW compressor",
        capacity: "250 L tank · 6 kW Panasonic Aquarea compressor",
        refrigerant: "R744 (CO₂)",
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Reclaim × Panasonic CO₂ split · 6 kW compressor + 250L tank",
        bestFor: "Households in cold-climate suburbs wanting faster recovery on the compact tank",
        ourTake:
          "The 6 kW Aquarea compressor gives faster tank recovery than the 4 kW · matters most in the hills (Emerald, Gembrook, Cockatoo) where cold-morning demand spikes are the tough case. The 6 kW also modulates further down, so at typical part-load it's actually MORE efficient than the 4 kW despite the larger nameplate.",
        specs: [
        ...
        related: ["panasonic-co2-4kw-250", "panasonic-co2-6kw-315", "co2-split-250-stainless"],
      },
      {
        slug: "panasonic-co2-6kw-315",
        name: "Reclaim × Panasonic CO₂ Split · 6 kW · 315L",
        model: "Panasonic Aquarea 6 kW compressor + Reclaim 315L tank",
        category: "heat-pump",
        categoryLabel: "Panasonic CO₂ split heat pump · 315L · 6 kW compressor",
        capacity: "315 L tank · 6 kW Panasonic Aquarea compressor",
        refrigerant: "R744 (CO₂)",
        veuEligible: true,
        photo: "/Reclaim Glass lined and stainless v2.png",
        photoAlt: "Reclaim × Panasonic CO₂ split · 6 kW compressor + 315L tank",
        bestFor: "Larger families in cold-climate suburbs — biggest capacity in the Panasonic Aquarea range",
        ourTake:
          "The top of the Reclaim × Panasonic range · 6 kW Aquarea compressor with the family-size 315 L tank. Best pick for a larger family in a hills postcode where cold-morning recovery matters and the household draw is high. Above this we'd move to the 400 L pure-Reclaim CO₂ (the Aquarea platform caps at 315 L).",
        specs: [
          { label: "Compressor", value: "Panasonic Aquarea 6 kW · CO₂ (R744)" },
          { label: "Tank capacity", value: "315 L (glass-lined or stainless — 316 duplex optional)" },
          { label: "Tank warranty", value: "10-yr glass-lined · 15-yr stainless · 15-yr 316 duplex" },
        ...
        related: ["panasonic-co2-6kw-250", "panasonic-co2-4kw-315", "co2-split-400-stainless"],
      },
    ],
  },
  ...
  // ================== THERMANN (Rheem) ==================
  {
    ...
    products: [
      ...
      // ---- Electric storage (Smart Electric range · 80/125/160/250/315/400 L) ----
      {
        slug: "electric-storage-80",
        name: "Thermann Smart Electric Storage · 80L",
        model: "T-SE-80 (1.8 kW element)",
        category: "electric-storage",
        categoryLabel: "Electric storage hot water · compact",
        capacity: "80 L · 1.8 kW element",
        veuEligible: false,
        photo: "/Thermann-Smart_Hot_Water_System-315L.png",
        photoAlt: "Thermann Smart Electric 80L compact storage tank",
        bestFor: "Studio, granny flat or 1-person unit where the hot-water draw is genuinely tiny",
        ourTake: "The 80 L is the compact size in the Smart Electric range · only sensible for a studio or granny flat where the daily draw is genuinely small. For anything more we'd move up the range or (much better) push a heat pump swap.",
        specs: [
      ...
      },
      {
        ...
        name: "Thermann Smart Electric Storage · 125L",
        model: "T-SE-125 (1.8 kW element)",
        category: "electric-storage",
        categoryLabel: "Electric storage hot water · small",
        capacity: "125 L · 1.8 kW element",
        veuEligible: false,
        photo: "/Thermann-Smart_Hot_Water_System-315L.png",
        photoAlt: "Thermann Smart Electric 125L small storage tank",
        bestFor: "1-2 person households · unit / small apartment replacement",
        ourTake: "125 L is a step up for a 1-2 person household. Still last-resort electric — VEU rebate doesn't apply — but if the customer's locked into electric for a legitimate reason (rental, body-corp restriction), this is the size.",
        specs: [
      ...
      },
      {
        ...
        name: "Thermann Smart Electric Storage · 160L",
        model: "T-SE-160 (2.4 kW element)",
        category: "electric-storage",
        categoryLabel: "Electric storage hot water · medium",
        capacity: "160 L · 2.4 kW element",
        veuEligible: false,
        photo: "/Thermann-Smart_Hot_Water_System-315L.png",
        photoAlt: "Thermann Smart Electric 160L medium storage tank",
        bestFor: "2-person household · townhouse replacement",
        ourTake: "160 L with the 2.4 kW element for a 2-person household. Element size steps up here so recovery time stays reasonable when draw increases.",
        specs: [
      ...
      },
      {
        ...
        name: "Thermann Smart Electric Storage · 250L",
        model: "T-SE-250 (3.0 kW element · single or twin)",
        category: "electric-storage",
        categoryLabel: "Electric storage hot water · family",
        capacity: "250 L · 3.0 kW element (twin element option)",
        veuEligible: false,
        photo: "/Thermann-Smart_Hot_Water_System-315L.png",
        photoAlt: "Thermann Smart Electric 250L family storage tank",
        bestFor: "3-4 person family emergency electric replacement",
        ourTake: "250 L is the family sweet spot in the electric range · what we quote for a 3-4 person household when the electric replacement is unavoidable. Twin-element option gives faster recovery. Still — a heat pump swap runs about half the cost per year, so we'll quote both.",
        specs: [
          { label: "Tank capacity", value: "250 L" },
      ...
      },
      {
        ...
        category: "electric-storage",
        categoryLabel: "Electric storage hot water · large family",
        capacity: "315 L · 3.0 kW element (twin element option)",
        veuEligible: false,
        photo: "/Thermann-Smart_Hot_Water_System-315L.png",
        photoAlt: "Thermann Smart Electric 315L large family storage tank",
        bestFor: "4-5 person family emergency electric replacement",
        ourTake:
          "The 315 L is the mid-large size in the Smart Electric range · we install this as a last-resort emergency replacement because electric storage doesn't qualify for VEU. For any planned upgrade, the Thermann heat pump equivalent is a much better financial outcome.",
        specs: [
          { label: "Tank capacity", value: "315 L" },
          { label: "Element power", value: "3.0 kW single (twin-element option available)" },
      ...
      },
      {
        ...
        name: "Thermann Smart Electric Storage · 400L",
        model: "T-SE-400 (3.0 kW element · twin)",
        category: "electric-storage",
        categoryLabel: "Electric storage hot water · biggest",
        capacity: "400 L · 3.0 kW twin element",
        veuEligible: false,
        photo: "/Thermann-Smart_Hot_Water_System-315L.png",
        photoAlt: "Thermann Smart Electric 400L largest storage tank",
        bestFor: "5+ person family / acreage properties with high hot-water draw",
        ourTake: "400 L is the biggest Smart Electric tank · for high-draw households or acreage properties where the daily hot-water demand won't fit a 315. Same last-resort caveat: the Reclaim CO₂ 400 L or Thermann heat pump is genuinely a better financial outcome for a planned upgrade.",
        specs: [
          { label: "Tank capacity", value: "400 L" },
  ...
  // ================== KADEN ==================
  {
    ...
    products: [
      ...
      },
      {
        ...
        related: ["kaden-multi-4", "kaden-multi-12", "mxz-2f"],
      },
      {
        slug: "kaden-multi-4",
      ...
      {
        slug: "kaden-multi-12",
        name: "Kaden Multi-Head · 12 kW",
        model: "KDM12 (5-port · 12 kW combined)",
        category: "multi-head",
        categoryLabel: "Multi-head outdoor unit · 12 kW",
        photo: "/Kaden Multi Head.jpg",
        ...
        specs: [
          { label: "Combined cool", value: "12.0 kW" },
          { label: "Combined heat", value: "14.0 kW" },
          { label: "Heads supported", value: "Up to 5" },
          { label: "Refrigerant", value: "R32" },
          { label: "Power supply", value: "1-phase 230 V" },
        ],
      ...
      {
        slug: "kaden-multi-18",
        name: "Kaden Multi-Head · 18 kW",
        model: "KDM18 (6-port · 18 kW combined)",
        category: "multi-head",
        categoryLabel: "Multi-head outdoor unit · 18 kW",
        photo: "/Kaden Multi Head.jpg",
        ...
        ourTake: "The 18 kW is Kaden's biggest multi-head — 6 indoor heads off one outdoor. Value alternative to the Mitsubishi MXZ-6C 6-port when the customer wants that scale of per-room control without going ducted.",
        specs: [
          { label: "Combined cool", value: "18.0 kW" },
          { label: "Combined heat", value: "21.0 kW" },
          { label: "Heads supported", value: "Up to 6" },
          { label: "Refrigerant", value: "R32" },
          { label: "Power supply", value: "1-phase 230 V" },
        ],
      ...
      },
      {
        ...
        model: "KDE (Classic + Low-Profile)",
        category: "ducted",
        categoryLabel: "Roof-mounted evaporative cooling",
        capacity: "Small · Medium · Large roof units · Classic + Low-Profile silhouettes",
        veuEligible: false,
        ...
        related: ["kaden-ducted-14", "kaden-gas-internal"],
      },
    ],
  },
