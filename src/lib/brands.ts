    ...
    products: [
      {
        ...
        name: "Brivis Wombat Internal Gas Ducted",
        model: "Wombat 3★ / 4★ / 5★ / 6★",
        category: "ducted",
        ...
        ourTake:
          "The Wombat is Brivis's entry internal ducted heater · we spec the star rating (3 through 6) to match how long you'll keep the home and the output (15 / 20 / 26 / 30 kW) to the heat load. Fits the same in-cupboard footprint as older Brivis and Braemar units so the retrofit is quick and the existing ducts reuse.",
        specs: [
    ...
    products: [
      {
        ...
        refrigerant: "R32",
        veuEligible: false,
        bestFor: "Bedroom on a value spec",
        ourTake:
          "A genuinely capable value bedroom split. Not as quiet as the MSZ-AP25 but a $600 saving that matters when you're doing three bedrooms.",
        specs: [{ label: "Cooling capacity", value: "2.5 kW" }],
        related: ["kaden-split-35", "kaden-split-5", "msz-ap25"],
      },
      {
        slug: "kaden-split-35",
        name: "Kaden 3.5 kW Split",
        model: "KDB35",
        category: "split-system",
        categoryLabel: "Wall split system",
        ...
        refrigerant: "R32",
        veuEligible: false,
        bestFor: "Master bedroom, value spec",
      ...
      },
      {
        ...
        refrigerant: "R32",
        veuEligible: false,
        bestFor: "Living zone, value spec",
        ourTake:
          "A big-selling value living-zone unit. About $700 saving vs the Mitsubishi MSZ-AP50 · not our first pick, but genuinely good value.",
        specs: [{ label: "Cooling capacity", value: "5.0 kW" }],
        related: ["kaden-split-35", "kaden-split-7", "msz-ap50"],
      },
      {
        slug: "kaden-split-7",
        name: "Kaden 7.0 kW Split",
        model: "KDB70",
        category: "split-system",
        categoryLabel: "Wall split system",
        ...
        refrigerant: "R32",
        veuEligible: false,
        bestFor: "Large open-plan living zone, value spec",
