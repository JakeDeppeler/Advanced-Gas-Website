...
// primary keyword + location, FAQs feed FAQPage schema, internal links flow
...
export const serviceContent: Record<string, ServiceContent> = {
  "air-conditioning-installation": {
    metaTitle: "Air Conditioning Installation Melbourne | Fixed Quotes | Advanced Gas",
    metaDescription:
      "Licensed split system, multi-head and ducted aircon installation across Melbourne. Fixed-price quotes, same-week installs, 6-year warranty.",
    h1: "Air Conditioning Installation Melbourne",
    intro:
      "Licensed refrigeration technicians installing split-system, multi-head and ducted air conditioning across Melbourne. Fixed-price quotes, same-week installs, and a 6-year workmanship warranty on every job. Whether you're cooling a single bedroom or zoning a whole home, we'll match the right system to your space and budget.",
    benefits: [
    ...
    faqs: [
      ...
      { q: "Is reverse cycle better than evaporative?", a: "For Melbourne's climate, yes. Reverse cycle cools in summer, heats efficiently in winter, and works regardless of humidity. Evaporative struggles on humid days." },
  ...
  "heat-pump-installation": {
    metaTitle: "Heat Pump Hot Water Installation Melbourne | From $33 with VEU Rebate",
    metaDescription:
      "Heat pump hot water systems installed across Melbourne from $33 with VEU rebates. Cut your hot water bill by up to 75%. Licensed install + 6-year warranty.",
    h1: "Heat Pump Hot Water Installation Melbourne",
    intro:
      "Cut your hot water energy use by up to 75% with a heat pump hot water system — installed across Melbourne by licensed plumbers from as little as $33 after Victorian Energy Upgrades (VEU) rebates. We handle the rebate paperwork, supply the unit, install it and lodge it with the regulator. You get a more efficient system and a lower power bill, with no fuss.",
    benefits: [
    ...
    faqs: [
      ...
      { q: "How much will I save on my power bill?", a: "Typical Melbourne homes save $400-$900 per year switching from an electric storage tank to a heat pump. Payback after rebate is usually under 2 years." },
  ...
  "aircon-servicing-repairs": {
    metaTitle: "Air Conditioning Service & Repairs Melbourne | All Brands",
    metaDescription:
      "Annual aircon servicing and repairs across Melbourne for all major brands. Same-day call-outs, fixed pricing, licensed refrigeration technicians.",
    h1: "Air Conditioning Service & Repairs Melbourne",
    intro:
      "Keep your aircon running efficiently and your warranty valid with annual servicing from licensed refrigeration technicians. We service all major brands across Melbourne — split systems, multi-heads and ducted — with same-day repairs when something breaks.",
    benefits: [
      ...
      { t: "Same-day breakdown calls", d: "Aircon down? We aim to be on-site same-day across Melbourne metro." },
  ...
  "gas-plumbing": {
    metaTitle: "Gas Plumbing Melbourne | Hot Water, Gas Fitting & Leak Detection",
    metaDescription:
      "Licensed Melbourne gas plumbers — hot water replacement, gas appliance installation, leak detection, emergency repairs. Same-day call-outs available.",
    h1: "Gas & Plumbing Services Melbourne",
    intro:
      "From emergency hot water replacement to gas appliance installation, our licensed gas fitters and plumbers handle the lot across Melbourne. Same-day emergency call-outs, fixed pricing, and full compliance certificates on every job.",
    benefits: [
      ...
      { t: "Emergency call-outs", d: "Same-day across Melbourne metro for no hot water, leaks and gas emergencies." },
    ],
    ...
    faqs: [
      ...
      { q: "Can you do emergency call-outs?", a: "Yes. Same-day across Melbourne metro for gas leaks, burst pipes and no-hot-water situations." },
