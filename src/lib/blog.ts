...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "For an all-in-one plug-in install where there's a power point within 2 metres of the current tank, the installation pack is:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "If you don't have a power point within 2 metres of the current hot water, add $350 for the circuit, so $2,960 all up." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "You're renting and the landlord won't upgrade. You have no power point within 2 metres of the tank AND don't want to pay $350 for the circuit. You genuinely need hot water in the next 4 hours and can't wait for a heat pump lead time (though we usually stock the R290 and can install within 48 hours)." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "ul", items: [
        ...
        "Is there a power point within 2 metres of the current tank? (If yes, all-in-one heat pumps plug in straight. If no, add $350 for the circuit.)",
