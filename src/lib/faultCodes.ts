...
export type FaultSystem = "aircon" | "heater" | "hot-water";
...
export const FAULT_CODES: FaultCode[] = [
  ...
  { brand: "Brivis", code: "22", system: "heater",  meaning: "Overheat safety limit tripped",                        firstCheck: "Blocked filter or blocked return-air path. Clean filter, reset unit.",                severity: "warn" },
  { brand: "Brivis", code: "37", system: "heater",  meaning: "Ignition failure — no gas or dirty igniter",           firstCheck: "Check gas supply on. If good, needs a gas fitter to inspect the igniter.",            severity: "warn" },
  { brand: "Brivis", code: "43", system: "heater",  meaning: "Fan proving switch open",                              firstCheck: "Fan not spinning up. Book gas heater service.",                                        severity: "warn" },
  { brand: "Brivis", code: "50", system: "heater",  meaning: "Communications lost (network wall control)",           firstCheck: "Check the network wire between the wall control and the heater.",                     severity: "info" },
