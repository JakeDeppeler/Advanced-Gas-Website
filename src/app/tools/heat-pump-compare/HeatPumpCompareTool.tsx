...
const HEAT_PUMPS: Row[] = [
  ...
  },
  {
    ...
    brand: "Panasonic",
    model: "Aquarea High-Perf 4 kW",
    eyebrow: "Split · R32 · 4 kW output",
    refrigerant: "R32 · low-GWP synthetic",
    cop: "~4.6 (A7/W35)",
    capacity: "Paired with 200-300 L tank",
    form: "Split",
    tank: "Sold separately (Panasonic tank or 3rd-party)",
    warranty: "5-yr compressor + 2-yr parts",
    installFrom: "$6,900",
    installTo: "$8,900",
    madeIn: "Japan · Panasonic Aquarea range",
    bestFor: "Small-to-medium household, buyers who want the Aquarea brand + high COP",
    pros: [
      "One of the highest COPs on the market at 7 °C ambient",
      "Well-known Panasonic parts network",
      "Modulating inverter compressor",
    ],
    cons: [
      "R32 refrigerant (not the natural CO₂ / R290 alternatives)",
      "Tank is separate — install cost + plumbing higher than an AIO",
    ],
  },
  {
    key: "panasonic-aquarea-6",
    brand: "Panasonic",
    model: "Aquarea High-Perf 6 kW",
    eyebrow: "Split · R32 · 6 kW output",
    refrigerant: "R32 · low-GWP synthetic",
    cop: "~4.4 (A7/W35)",
    capacity: "Paired with 300-400 L tank",
    form: "Split",
    tank: "Sold separately (Panasonic tank or 3rd-party)",
    warranty: "5-yr compressor + 2-yr parts",
    installFrom: "$7,900",
    installTo: "$9,900",
    madeIn: "Japan · Panasonic Aquarea range",
    bestFor: "Larger household (5+), pool + domestic combo, homes with hydronic heating too",
    pros: [
      "6 kW output handles bigger tanks + multi-purpose loops",
      "Same reliable Aquarea compressor as the 4 kW",
      "Modulates down for shoulder-season efficiency",
    ],
    cons: [
      "R32 refrigerant (not the natural CO₂ / R290 alternatives)",
      "Tank sold separately — total install cost highest of the group",
    ],
  },
  {
    key: "sanden-eco",
