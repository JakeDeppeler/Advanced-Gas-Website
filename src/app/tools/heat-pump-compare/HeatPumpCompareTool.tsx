...
const HEAT_PUMPS: Row[] = [
  ...
  },
  {
    ...
    bestFor: "Best-value VEU rebate outcome — Hampton Park / Cranbourne stock swap-outs",
    pros: [
  ...
  },
  {
    ...
    brand: "Thermann",
    model: "Integrated HP",
    eyebrow: "All-in-one · R290 · 270/315 L",
    refrigerant: "R290 (propane) · natural",
    cop: "~3.8",
    capacity: "270 / 315 L",
    form: "All-in-one",
    ...
    bestFor: "Buyers who want a Reece-supplied Australian-made brand",
    pros: [
      "Australian-made by Dux",
      "Solid mid-tier warranty (7-yr tank)",
      "Reece distribution — same-day parts state-wide",
    ],
    cons: [
      "COP slightly lower than Reclaim CO₂",
      "Fewer capacity options than Reclaim",
    ],
  ...
  },
  {
    ...
    brand: "Thermann",
    model: "Split Heat Pump · Glass-lined",
    ...
    bestFor: "Split-form R290 alternative to Reclaim CO₂ at a lower entry price",
    pros: [
      "Australian-made by Dux",
